...
import uv.tc.packetworldmovil.databinding.ActivityLoginBinding
import uv.tc.packetworldmovil.dto.RSAuntenticacion
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun verificarCredencialesColaborador(numeroPersonal: String, contrasena: String) {
        ...
        Ion.with(this@LoginActivity)
            .load("POST", Constantes().URL_WS + "login") // URL de la API para login
    ...
    private fun serializarRespuestaLogin(json: String) {
        val gson = Gson()
        val respuestaLogin = gson.fromJson(json, RSAuntenticacion::class.java)
