...
import uv.tc.packetworldmovil.adapters.PaquetesAdapter
import uv.tc.packetworldmovil.databinding.ActivityDetalleEnvioBinding
import uv.tc.packetworldmovil.util.Constantes
import uv.tc.packetworldmovil.pojo.Cliente
...
class DetalleEnvioActivity : AppCompatActivity() {
    ...
    private fun consultarInformacionCliente(idCliente: Int) {
        ...
        Ion.with(this@DetalleEnvioActivity)
            .load("GET", "${Constantes().URL_WS}enviosEspeciales/app/cliente/${idCliente}")
            .asString()
